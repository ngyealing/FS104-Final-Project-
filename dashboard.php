...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#"><?php echo $_SESSION['full_name'];?></a>
          ...
          <div class="col-md-3">
            <a href="./trips.php" style="text-decoration: none;">
              <div class="border p-1">
                <div class="border p-1"><h4 style="text-align:center;">TRIPS</h4></div>
              </div>
            </a>
          </div>
          <div class="col-md-3">
            ...
            <div class="border p-1">
            <div class="border p-1"><h4 style="text-align:center;">BOOKINGS</h4></div>
              </div>
            </a>
          </div>
          <div class="col-md-3">
            ...
            <div class="border p-1">
            <div class="border p-1"><h4 style="text-align:center;">CONTACTS</h4></div>
              </div>
            </a>
          </div>
          <div class="col-md-3">
            ...
            <div class="border p-1">
            <div class="border p-1"> <h4 style="text-align:center;">ORDERS</h4></div>
              </div>
            </a>
          </div>
        </div>
